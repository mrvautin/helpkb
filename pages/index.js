    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            if(settings.config.indexType === 'categories'){
                ...
                const res = await callApi(`/api/search/count/10`, 'get', {}, {});
                setData(res);
            }
        };
        fetchData();
                                ...
                                <div key={i} className="col-12 col-md-4 mb-2">
                                    <div  className="card">
                                        <div className="card-body m-4 text-center">
                                            ...
                                            <Link passHref={true} href={"/category/" + result.url}>
                                                <div className="btn btn-primary">See articles <span className="badge bg-light text-dark">{result.count}</span></div>
                                            </Link>
                                        </div>
                                    </div>
                                </div>
